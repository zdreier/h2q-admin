...
const ACCOUNTS = [
  {
    ...
    flags: ["CONTINUOUS_FLOW", "PRESSURE_SPIKE"], lastRead: "Today, 6:00 AM",
    flowRate: 1.5, durationHrs: 3, zone: "North",
  ...
  },
  {
    ...
    flags: ["PRESSURE_SPIKE"], lastRead: "Today, 6:00 AM",
    flowRate: 0, durationHrs: 0, zone: "South",
...
const FLAG_LABELS = {
  ...
  PRESSURE_SPIKE:  { label: "Pressure", color: "#92480A", bg: "#FDF3E7", border: "#F5CFA0" },
  ...
  const filtered = useMemo(() => {
    return ACCOUNTS.filter(a => {
      ...
      const matchFlag = filterFlag === "all" ||
        ...
        (filterFlag === "pressure" && a.flags.includes("PRESSURE_SPIKE")) ||
          ...
          {tab === "flags" && !selectedAccount && (
            <div className="fade-up">
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 20 }}>
                ...
                <KPICard label="Pressure spikes"        value={ACCOUNTS.filter(a => a.flags.includes("PRESSURE_SPIKE")).length} sub="Accounts flagged" accent="amber"/>
